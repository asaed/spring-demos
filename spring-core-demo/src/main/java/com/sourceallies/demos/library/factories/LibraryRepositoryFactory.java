...
public class LibraryRepositoryFactory {
    ...
    public LibraryRepository createLibraryRepository(String libraryBasePath){
        ...
        GenreRepository genreRepository = (new GenreRepositoryFactory()).createGenreRepository(libraryBasePath);
        return new LibraryRepository(library, bookRepository, authorRepository, genreRepository);
    }
}
